...
public class PriceController {
    ...
    @PostMapping("/forecase-price")
    public ResponseResult forecasePrice(@RequestBody PriceDto priceDto){
        ...
        return priceService.forecasePrice(depLongitude, depLatitude, destLongitude, destLatitude);
    }
}
